...
- [Mac Install](https://app.box.com/leadconverisoncraft-mac "Install Lead Conversion for Mac OS X"): Go to "More" and then click "Download." You may have to extract a zip file afterword; otherwise, it should be immediately runnable.
